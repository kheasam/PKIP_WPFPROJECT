...
Public Class Cr_Registration
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pkip_project.Cr_Registration.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Registration
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Registration = New Cr_Registration()
        rpt.Site = Me.Site
        Return rpt
    End Function
